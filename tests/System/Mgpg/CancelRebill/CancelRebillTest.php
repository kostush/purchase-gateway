...
namespace Tests\System\Mgpg\CancelRebill;

use Illuminate\Http\Response;
use Tests\System\Mgpg\ProcessPurchase\ProcessPurchaseBase;

class CancelRebillTest extends ProcessPurchaseBase
{
    /**
     * @test
     * @return array
     * @throws \Exception
     */
    public function purchase_should_return_success_with_netbilling_biller(): array
    {
    ...
    /**
     * @test
     * @depends purchase_should_return_success_with_netbilling_biller
     *
     * @param array $processResponse
     */
    public function cancel_rebill_operation_should_be_successful(array $processResponse): void
    {
        $header = [
        ...
        $response = $this->json(
            'POST',
            $this->validCancelRebillRequestUri(),
            $cancelData,
            $header
        );
        ...
        $this->assertSame($cancelRebillResponse['invoice']['isDisabled'], false);
     ...
     * @param array $processResponse
     */
    public function cancel_rebill_operation_should_be_declined(array $processResponse): void
    {
        $header = [
            'Content-Type' => 'application/json',
            'X-CORRELATION-ID' => '23dbca8f-0323-404b-97c7-e763d9af8819'
     ...
     * @return string
     */
    protected function validCancelRebillRequestUri(): string
    {
        return '/mgpg/api/v1/cancel-rebill';
    }
}