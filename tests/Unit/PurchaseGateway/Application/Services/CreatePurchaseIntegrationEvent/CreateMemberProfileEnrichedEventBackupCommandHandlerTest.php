...
class CreateMemberProfileEnrichedEventBackupCommandHandlerTest extends UnitTestCase
{
    /**
     * @var MockObject|CreateMemberProfileEnrichedEventBackupCommandHandler
     */
    private $handler;
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = $this->getMockBuilder(CreateMemberProfileEnrichedEventBackupCommandHandler::class)
     ...
     */
    public function operation_should_not_create_integration_event_if_no_subscription_created(): void
    {
     ...
     * @throws \ReflectionException
     */
    public function operation_should_create_integration_event(): void
    {
        /** @var ItemToWorkOn|MockObject $handler */
        $eventMock = $this->createMock(ItemToWorkOn::class);
        $eventMock->method('body')->willReturn(
     ...
     * @throws \ReflectionException
     */
    public function operation_should_retrieve_transaction_information(): void
    {
        /** @var ItemToWorkOn|MockObject $handler */
        $eventMock = $this->createMock(ItemToWorkOn::class);
        $eventMock->method('body')->willReturn(
     ...
     * @throws \ReflectionException
     */
    public function create_purchase_enriched_event_should_add_integration_event()
    {
        ...
        $this->handler->expects($this->once())->method('addIntegrationEvent');

        $serviceBusFactory = $this->createMock(ServiceBusFactory::class);
        $serviceBusFactory->method('make')->willReturn($this->createMock(ServiceBus::class));
     ...
     * @throws \ReflectionException
     */
    public function operation_should_create_integration_event_for_qysso_rebill(): void
    {
        /** @var ItemToWorkOn|MockObject $handler */
        $eventMock = $this->createMock(ItemToWorkOn::class);
        $eventMock->method('body')->willReturn(
