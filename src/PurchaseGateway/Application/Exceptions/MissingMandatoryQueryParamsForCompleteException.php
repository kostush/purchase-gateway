...
class MissingMandatoryQueryParamsForCompleteException extends ValidationException implements ReturnsNextAction
{
    /**
     * @var int $code Error code
     */
    protected $code = Code::MISSING_MANDATORY_COMPLETE_PARAMS;
